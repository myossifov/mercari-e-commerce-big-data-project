...
|---:|---:|---:|---:|---:|
| 1 | 16 GB | 5.97 | 1.00x | 100% |
| 4 | 3.5 GB | 5.74 | 1.04x | 26.0% |
| 7 | 2 GB | 5.58 | 1.07x | 15.3% |
...
Distributed computing helped process this large dataset because Spark distributed the preprocessing steps as well as model training across workers. This reduces computation time to the point where we can make use of the SDSC clusters and Apache Spark in order to run this analysis in a timely way. 
...
Travis Gillespie: Coder/Writer: For this project, I contributed to the EDA write-ups, model evaluation, and hyperparameter tuning. I was primarily responsible for part 4 in milestone 2, part 2 in milestone 3, part 1 in milestone 4, and the speed up analysis.
